...
module ExtendedCommandInjection {
  /**
...
//   /**
//    * A agrument `x` pass to SystemCommandExecution from a server, considered as a flow source for command injection.
//    * Example: `child_process.spawn("git", x)
//    */
//   class ArgurmentAsSink extends Sink {
//     ArgurmentAsSink() { this = any(SystemCommandExecution sys).getArgumentList() }
//   }
}
