...
import javascript
import ExtendedCommandInjectionCustomizations::ExtendedCommandInjection
import ExtendedIndirectCommandArgument

/**
 * A taint-tracking configuration for reasoning about command-injection vulnerabilities.
 */
class Configuration extends TaintTracking::Configuration {
  Configuration() { this = "Extend CommandInjection" }
